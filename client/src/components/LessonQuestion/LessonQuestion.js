...
class LessonQuestion extends React.Component {
    ...
    inputFieldValidation() {
        if (!this.state.title || !this.state.linkToVideo || !this.state.question1PauseTime || isNaN(this.state.question1PauseTime) || !this.state.question1 || !this.state.question1AnswerA || !this.state.question1AnswerB || !this.state.question1AnswerC || !this.state.question1AnswerD || !this.state.question1CorrectAnswer) {
        ...
        return (
            ...
            <div>
                <div className="form-group">
                    ...
                    {(isNaN(this.state.question1PauseTime) && this.state.submitFlag) ? <div className="error-text">Please enter a number</div> : " "}
                </div>
                <div className="form-group">
                    Question 1: <br /> <input
                        type="email"
